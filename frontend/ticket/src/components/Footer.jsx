         ...
         <footer className="footer" id="footer-contact">
			<div className="container footer-container">
					...
					<ul className="contact-list">
						...
						<a className="contact-link" href="tel:8 (800) 000 00 00" target="_blank">
							<img src={Footerphone} alt="Телефон" className="contact-image"/>
                           <p className="contact-desk">8 (800) 000 00 00</p>
						</a>
                         </li>
							<li className="contact-item">
								<a className="contact-link" href="mailto:inbox@mail.ru" target="_blank">
...
<img src={footerskype} alt="Skype" className="contact-image"/>
...
<li className="contact-item">
	<div className="contact-link">
		<img src={footerVector} style="margin-right: 10px;" alt="Адрес на карте" className="contact-image"/>
		<p className="contact-desk">г. Москва <br/>ул. Московская <br/>27-35 555 555</p>
	</div>
</li>
					</ul>					
					</div>
					...
					<div className="social-media-communication">
						...
						<ul className="media-social-link">
							<li className="subscribe-social-item">
								<a className="social-link" href="https://www.youtube.com"><img src={footeryoutube} alt="YouTube" /></a>	
							</li>
							<li className="subscribe-social-item">
							<a className="social-link" href="https://www.linkedin.com"><img src={footerin} alt="LinkedIn" /></a>
							</li>
								<li className="subscribe-social-item">
									<a className="social-link" href="https://www.google.com"><img src={footerG} alt="Google+" /></a>
									</li>
										<li className="subscribe-social-item">
										<a className="social-link" href="https://www.facebook.com"><img src={footerF} alt="Facebook" /></a>
											</li>
												<li className="subscribe-social-item">
												<a className="social-link" href="https://twitter.com"><img src={footerTwit} alt="Twitter" /></a>
												</li>						
						</ul>
					</div>
				</div>
				...
				<div className="container">
					<div className="footer-copyright">
						<div className="container-copyright">			
							<a className="copyright-logo-link" href="">Лого</a>
							
							<button className="copyright-btn" type="button"><img src={footerarrow} alt="Стрелка" /></button>
